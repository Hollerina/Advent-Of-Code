...
For Advent of Code 2023 I have decided to test a variety of my programming langues and therefore my soloutions will consist of vairous languages. Below is the Languages I have used so far:
...
<ul>
  ...
  <li>
    ...
    <span>&emsp;&emsp;&emsp;If it matches any loop through each possibility for that character comparing each to the orginal string.</span></br>
...
<details closed>
  ...
  <ul>
    <li>
      <b>Part 1:</b><br/>
      <b>&emsp;Input:</b><br/>
      <span>&emsp;&emsp;&emsp;List of games which incude the sets played within each game.</span><br/>
      <b>&emsp;Task:</b><br/>
      ...
      <b>&emsp;Soloution Overview:</b></br>
      <span>&emsp;&emsp;&emsp;For each differnt game split the input up into the different sets given.</span><br/>
      <span>&emsp;&emsp;&emsp;For each element in the set find the maxium number it can be for that colour and compare to the value.</span><br/>
